...
import { bulkImportUsers, createUser, getMyProfile, listUsers, updateMyPassword, updateMyProfile, updateUserActive, updateUserApproval, updateUserPassword } from "./users.controller.js";
...
usersRouter.patch("/:id/approval", auth, tenantResolver, roleGuard("ADMIN", "SUPER_ADMIN"), asyncHandler(updateUserApproval));
usersRouter.patch("/:id/active", auth, tenantResolver, roleGuard("ADMIN", "SUPER_ADMIN"), asyncHandler(updateUserActive));
